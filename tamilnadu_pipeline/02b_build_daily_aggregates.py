...
================================
PHASE 2 REPAIR 1 (Objective 1 Plan v3.0, Section 4.3) — TAMIL NADU

climate_tamilnadu_points.csv keeps only 3 rows/day (sunrise, noon, sunset).
...
02_combine_tamilnadu.py only ever read 3 of those ~8760 hours per year.
...
OUT_DAILY = PROCESSED_DIR / "daily_aggregates_tamilnadu.csv"
OUT_TIER2 = PROCESSED_DIR / "tier2_signature_tamilnadu.csv"
...
def main():
    print("=" * 68)
    print("  PHASE 2 REPAIR 1 — Daily-Integral (Tier 2) Indices — Tamil Nadu")
    print("=" * 68)
    ...
    print("=" * 68)
    print("\nNext: run 04_preprocess_tamilnadu.py (Phase 2) if not already done, "
