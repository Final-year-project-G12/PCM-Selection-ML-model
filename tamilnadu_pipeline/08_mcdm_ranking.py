...
def main():
    print("=" * 68)
    print("  Phase 6 — MCDM Ranking (TOPSIS + GRA, entropy+AHP weights) — Tamil Nadu")
    print("=" * 68)
    ...
    if top1_sets.nunique() == 1:
        ...
        print("    (a) State it as a finding: TN's climate regimes differ more "
    ...
    print("+ cluster_profiles_tamilnadu.csv (Phase 8) and you have a complete")
    print("Objective 1.")
