...
OUTPUT : data/preprocessed/
           tamilnadu_cleaned_physical.csv   <- Phase 3 (04b) reads THIS.
           ...
           tamilnadu_cleaned_scaled.csv     <- Same rows, MinMax-scaled
...
---------------------------------------------------
The old 04_preprocess_tamilnadu.py assumed one row per (city, hour) —
...
# ═══════════════════════════════════════════════════════════
log("=" * 68)
log("  PHASE 2 — PREPROCESSING & QUALITY CONTROL — Tamil Nadu")
log("=" * 68)
...
# ═══════════════════════════════════════════════════════════
physical_path = PREPROCESSED_DIR / "tamilnadu_cleaned_physical.csv"
...
scaled_path = PREPROCESSED_DIR / "tamilnadu_cleaned_scaled.csv"
