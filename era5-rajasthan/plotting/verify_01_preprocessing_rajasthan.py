...
Output: outputs/objective1_plots_rajasthan/verify_preprocessing/
Run AFTER: Phase 2 preprocessing
...
PRE  = os.path.join(BASE,"data","processed","climate_rajasthan_points_clean.csv")
OUT  = os.path.join(BASE,"outputs","objective1_plots_rajasthan","verify_preprocessing")
