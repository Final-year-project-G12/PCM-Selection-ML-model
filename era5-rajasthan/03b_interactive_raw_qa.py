...
Direct port of the Tamil Nadu pipeline's 03b_interactive_raw_qa.py — only
the region name and the output directory (PLOTSV2/raw_interactive/ instead
of data/plots/raw_interactive/) differ.
