...
====================================
Interactive (Plotly) version of 04d_postprocess_plots.py — the 1:1 port of
the Tamil Nadu pipeline's 04c_interactive_postprocess_qc.py. Same checks
(A, B, D, E, F; the qc_report.txt bar chart C stays in the PNG script),
reading rajasthan_cleaned_physical.csv as zoomable/hoverable HTML.

ADAPTATION NOTE: rajasthan_cleaned_physical.csv is ~4 GB, so this reads
only the columns the checks touch (usecols filter). Output is identical.
...
HOW TO RUN:
  python 04e_interactive_postprocess_qc.py
"""
