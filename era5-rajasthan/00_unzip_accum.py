"""
00_unzip_accum.py — Run this BEFORE 02_combine_rajasthan.py
============================================================
...
def main():
    ...
    if counts["error"] > 0:
        ...
        print("\n  ✅  All ZIP files extracted. Now run: python 02_combine_rajasthan.py")
    else:
        print("\n  ✅  All files were already valid NetCDF.")
        print("     Now run: python 02_combine_rajasthan.py")
    print("=" * 60)
