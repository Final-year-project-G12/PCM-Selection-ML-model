"""
Shared paths and CDS API settings for the ERA5 Assam pipeline.
...
# Population-weighted points pipeline
...
CLIMATE_COMBINED_FILE = PROCESSED_DIR / "climate_assam_all.csv"

POPULATION_GRID_FILE = PROCESSED_DIR / "population_grid_points.csv"
SUNTIMES_FILE = PROCESSED_DIR / "suntimes.csv"
COMBINED_POINTS_FILE = PROCESSED_DIR / "climate_assam_points.csv"
