...
2. An interior semi-arid dry zone (e.g., Coimbatore/Tiruppur plains).
3. A high-relief montane climate (e.g., Nilgiris hills: Ooty/Coonoor), which represents a cold temperate microclimate.
4. An out-of-phase monsoon cycle (heavy rain during the North-East monsoon in Oct-Dec, whereas most of India receives rain during the South-West monsoon in Jun-Sep).
...
2. **N2**: Two-tier signature (sun-event + daily-integral) rather than single monthly temperatures.
3. **N3**: Corrected 42–70°C SWH-specific melting band rather than the common 18–28°C building-comfort band.
