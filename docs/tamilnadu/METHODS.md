...
*This document covers the 16 algorithm-bearing scripts in the Tamil Nadu pipeline (`00a`, `00b`, `01`, `01b`, `02`, `02b`, `03`, `04`, `04b`, `05`, `06`, `07`, `08`, `10`, `09`, `11` — Phase 1 through Phase 8). Orchestration and QA/visualisation helpers (`run_all_tamilnadu.py`, `00_unzip_accum.py`, `03b_agreement_analysis.py`, `07b_charging_feasibility.py`, `04c*`, `04d`, `05b`–`05d`, `plots/verify_0*`, `plots_tamilnadu_ppt/*`) are audited in the phase-audit docs and `23_PLOTS_GUIDE.md`, not here. All algorithmic choices are made in conformance with `Objective1_PCM_Climate_Framework_Plan_v3.docx`. Critical bugs corrected in v3.1 (August 2026); config-symbol and PCM-input-path fixes applied 2026-09-07 (see `20_IMPLEMENTATION_ISSUES.md`). Use **Part 0** for supervisor presentation; use per-script **Literature comparison** and **Reference Papers — Chosen vs Rejected** tables for thesis methodology section.*