...
data (climate_uttarakhand_points.csv), same six checks (A-F), but as
...
INPUT  : data/processed/climate_uttarakhand_points.csv
...
print("=" * 68)
print("  Interactive Raw Data QA — Uttarakhand Population Points")
