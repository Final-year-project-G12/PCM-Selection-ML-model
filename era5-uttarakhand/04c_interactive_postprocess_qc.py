...
as-is in the PNG script), reading uttarakhand_cleaned_physical.csv, as
zoomable/hoverable HTML.

Requires: pip install plotly

INPUT  : data/preprocessed/uttarakhand_cleaned_physical.csv
...
print("=" * 68)
print("  Interactive Post-Preprocessing QA — Uttarakhand")
