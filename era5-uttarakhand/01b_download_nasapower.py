"""
NASA POWER DOWNLOAD — UTTARAKHAND POPULATION POINTS  (cross-check source)
=============================================================================
...
This is an independent source from ERA5 — 02_combine_uttarakhand.py merges
...
pattern as 01_download_era5_uttarakhand.py's StatusTracker.
...
# ═══════════════════════════════════════════════════════════
# STATUS TRACKER  (same pattern as 01_download_era5_uttarakhand.py)
# ═══════════════════════════════════════════════════════════
...
def main():
    ...
    print("\n" + "═" * 68)
    print("  NASA POWER Download — Uttarakhand Population Points")
    ...
    print("═" * 68)
    print("\nNext step: run 01_download_era5_uttarakhand.py (if not already done), "
