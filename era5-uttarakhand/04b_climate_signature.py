...
It merges that script's tier2_signature_uttarakhand.csv (true daily GHI
...
INPUT  : data/preprocessed/uttarakhand_cleaned_physical.csv   (04's Phase-2 output)
         data/processed/tier2_signature_uttarakhand.csv       (02b's output)
OUTPUT : data/processed/signatures/
           climate_signature_uttarakhand.csv   <- one row per point_id: Tier 1
                                                  + Tier 2 + interactions +
...
TIER2_FILE = PROCESSED_DIR / "tier2_signature_uttarakhand.csv"
...
print("=" * 68)
print("  PHASE 3 — CLIMATE SIGNATURE CONSTRUCTION (Tier1+Tier2) — Uttarakhand")
...
out_path = SIGNATURE_DIR / "climate_signature_uttarakhand.csv"
...
ax.set_title("Climate Signature Correlation (Tier1+Tier2 canonical) — Uttarakhand points")
plt.tight_layout()
...
print("=" * 68)
print("\nNext: run 05_cluster_uttarakhand.py (Phase 4, within-Uttarakhand only).")
