...
=============================
Interactive (Folium + Plotly) explorer for 05_cluster_uttarakhand.py's
...
INPUT  : data/processed/clustering/cluster_assignments_uttarakhand.csv
         data/processed/clustering/cluster_profiles_uttarakhand.csv
         data/processed/clustering/bic_selection_uttarakhand.csv
...
BIC_FILE = CLUSTER_DIR / "bic_selection_uttarakhand.csv"

PALETTE = px.colors.qualitative.Set1

print("=" * 68)
print("  Interactive Cluster Explorer — Uttarakhand")
print(f"  Output : {OUT_DIR}/")
print("=" * 68)

for f in (ASSIGN_FILE, PROFILE_FILE):
    if not f.exists():
        raise FileNotFoundError(f"{f} not found — run 05_cluster_uttarakhand.py first.")
