...
OUTPUT : data/preprocessed/
           uttarakhand_cleaned_physical.csv   <- Phase 3 (04b) reads THIS.
           ...
           uttarakhand_cleaned_scaled.csv     <- Same rows, MinMax-scaled
...
---------------------------------------------------
The old 04_preprocess_uttarakhand.py assumed one row per (city, hour) —
...
HOW TO RUN:
  python 04_preprocess_uttarakhand.py
"""
...
# ═══════════════════════════════════════════════════════════
log("=" * 68)
log("  PHASE 2 — PREPROCESSING & QUALITY CONTROL — Uttarakhand")
log("=" * 68)
...
# ═══════════════════════════════════════════════════════════
physical_path = PREPROCESSED_DIR / "uttarakhand_cleaned_physical.csv"
...
scaled_path = PREPROCESSED_DIR / "uttarakhand_cleaned_scaled.csv"
