"""
SUN-EVENT TIME TABLE — UTTARAKHAND
=============================================================================
...
This table drives everything downstream: 01_download_era5_uttarakhand.py uses
it to compute which UTC hour windows to request, and 02_combine_uttarakhand.py
...
Uttarakhand's sunrise can fall before 00:00 UTC (i.e. on the *previous* UTC
calendar date) for eastern points in summer — `time_utc` always reflects the
...
def main():
    ...
    print("=" * 68)
    print("  Sun-Event Time Table — Uttarakhand")
    print("=" * 68)
    ...
    print("=" * 68)
    print("\nNext step: run  01_download_era5_uttarakhand.py  and  01b_download_nasapower.py")
