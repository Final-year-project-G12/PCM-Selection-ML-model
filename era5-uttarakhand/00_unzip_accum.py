"""
00_unzip_accum.py — Run this BEFORE 02_combine_uttarakhand.py
============================================================
...
# Scans both the old full-state grid archive and the new population-points
# archive — CDS API's "downloads as zip" quirk applies to either.
...
def fix_file(filepath):
    ...
    try:
        ...
        shutil.move(extracted, filepath)
...
def main():
    ...
    if counts["error"] > 0:
        ...
        print("\n  ✅  All ZIP files extracted. Now run: python 02_combine_uttarakhand.py")
    else:
        print("\n  ✅  All files were already valid NetCDF.")
        print("     Now run: python 02_combine_uttarakhand.py")
    print("=" * 60)
