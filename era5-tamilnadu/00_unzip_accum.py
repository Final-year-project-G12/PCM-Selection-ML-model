...
Scans both the old full-state grid archive (RAW_GRID_DIR, if you have one
from a previous run) and the new population-points archive (RAW_POINTS_DIR)
— the CDS API's "downloads as zip" quirk applies to either.
