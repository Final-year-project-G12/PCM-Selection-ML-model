...
# COVERAGE_TARGET (0.875 — keep the minimal set of highest-population cells
# covering this fraction of total state population) is imported from
# config.py / pcm_shared_config.py so every state's grid is built to the
# same coverage. Value unchanged.
