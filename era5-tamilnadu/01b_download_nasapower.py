"""
NASA POWER DOWNLOAD — TAMIL NADU POPULATION POINTS  (cross-check source)
=============================================================================
...
This is an independent source from ERA5 — 02_combine_tamilnadu.py merges
both so ERA5 and NASA POWER values can be cross-checked against each other
for the same point/date/event. Identical to 01b_download_nasapower.py in
the Rajasthan pipeline; only the points file it reads differs (via config.py).
...
pattern as 01_download_era5_tamilnadu.py's StatusTracker.
...
# ═══════════════════════════════════════════════════════════
# STATUS TRACKER  (same pattern as 01_download_era5_tamilnadu.py)
# ═══════════════════════════════════════════════════════════
...
def main():
    ...
    print("\n" + "═" * 68)
    print("  NASA POWER Download — Tamil Nadu Population Points")
    ...
    print("═" * 68)
    print("\nNext step: run 01_download_era5_tamilnadu.py (if not already done), "
