...
print("=" * 68)
print("  Interactive Climate Signature Explorer — Tamil Nadu")
...
fig = px.imshow(corr, text_auto=".2f", color_continuous_scale="RdBu_r", zmin=-1, zmax=1,
                 title="Climate Signature Correlation (Tier1+Tier2 canonical) — Tamil Nadu")
...
fig.update_layout(title="Signature index distributions across 133 points", height=280 * nrows)
...
fig = px.scatter_matrix(sig, dimensions=key_cols, hover_name="point_id",
                         title="Key PCM-facing indices — look for the clusters "
                               "05_cluster_tamilnadu.py should be finding")
